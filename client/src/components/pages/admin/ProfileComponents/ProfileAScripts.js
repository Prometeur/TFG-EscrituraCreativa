/*
*  Name_file :ProfileAScripts.js
*  Description: Componente que contiene la lista de escritos del estudiante, versión del administrador
*/
import React, { Component } from 'react';
import axios from 'axios';
import Cookies from 'universal-cookie';

const baseUrl = "http://localhost:3001/Admin/getScriptsByStudent";
const cookies = new Cookies();//cokies guarda la informacion de la sesion del usuario


class ProfileAScripts extends Component {
...
export default ProfileAScripts;