...
class SearchStudentRes extends Component {
    ...
    componentDidMount() {
        ...
        TeacherService.searchApplicant(this.state.searchStudent, this.state.searchType).then(response =>{
            ...
            <div className="container">
                <Card className="card-edit">
                    ...
                    <div>
                            ...
                            <h2> Resultados de buscar solicitantes con {this.state.searchType} similar a {this.state.searchStudent}:</h2>
                    </div>
                    <div>
