/*
*  Name_file :GroupAStudents.js
*  Description: Contiene los estudiantes de un grupo según un ID dado.
*    
*/
...
class GroupAInfo extends Component {
    ...
    state = {
      ...
      peticionPost = () => {
        axios.post("http://localhost:3001/admin/getStudentsOfGroup", { grupo: cookies.get('groupSelect')  }).then(response => {
